            ...
            <div class="modal fade" id="errorIdModal" role="dialog" aria-hidden="false">
                <div class="modal-dialog modal-dialog-centered">                    
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="btnAceptarError">Aceptar</button>
                        </div>
                    </div>
                </div>
            </div>
...
//            const montoRecibido = document.getElementById('montoRecibido');
            ...
            ponleFocus();
                    ...
                    var Idproducto = document.getElementById('txtID').value;
                            console.log('Valor ingresado ', Idproducto);
                            const fileDir = 'Controlador?menu=NuevaVenta&accion=Agregar&txtID=' + Idproducto;
