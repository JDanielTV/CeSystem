                ...
                <div class="card-body">
                    <form action="Controlador?menu=Productos" method="POST">
                        ...
                        <div class="form-group" id="DivDescripcionCorta" style="display: none">
                            ...
                            <input type="text" value="${producto.getDescripcionc()}" name="txtDescripcionCorta" class="form-control" size="5" id="txtDescripcionCorta" maxlength="50">
                        </div>
                        ...
                        <div class="form-group" id="DivPrecioCompra" style="display: none">
                            ...
                            <input type="text" value="${producto.getPreciocompra()}" name="txtPcompra" class="form-control" size="5" id="txtPcompra">
                        </div>
